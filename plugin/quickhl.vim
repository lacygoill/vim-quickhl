...
if has('gui_running') || &t_TI =~# "\e\\[>4;[12]m"
    ...
    "    - current line
    "}}}
    nno <unique> <m-m>g* <cmd>call quickhl#word('n')<cr>
    nno <unique> <m-m>* <cmd>call quickhl#whole_word()<cr>
    xno <unique> <m-m> <c-\><c-n><cmd>call quickhl#word('v')<cr>
    nno <expr><unique> <m-m> quickhl#op()
    nno <expr><unique> <m-m><m-m> quickhl#op() .. '_'

    " clear all highlights
    nno <unique> <m-m>C <cmd>call quickhl#reset()<cr>
    " clear highlight of the word under the cursor
    nno <unique> <m-m>c <cmd>call quickhl#clear_this('n')<cr>
    " clear highlight of the visual selection
    xno <unique> m<m-m> <c-\><c-n><cmd>call quickhl#clear_this('v')<cr>
    ...
    " toggle global lock
    nno <unique> co<m-m> <cmd>call quickhl#lock_toggle()<cr>

    nno <unique> <m-m>? <cmd>call quickhl#show_help()<cr>
else
    " If you want to change `F24`, you'll need to update `autoload/lg/map.vim`.
    nno <unique> <f24>g* <cmd>call quickhl#word('n')<cr>
    nno <unique> <f24>* <cmd>call quickhl#whole_word()<cr>
    xno <unique> <f24> <c-\><c-n><cmd>call quickhl#word('v')<cr>
    nno <expr><unique> <f24> quickhl#op()
    nno <expr><unique> <f24><f24> quickhl#op() .. '_'
    nno <unique> <f24>C <cmd>call quickhl#reset()<cr>
    nno <unique> <f24>c <cmd>call quickhl#clear_this('n')<cr>
    xno <unique> m<f24> <c-\><c-n><cmd>call quickhl#clear_this('v')<cr>
    nno <unique> co<f24> <cmd>call quickhl#lock_toggle()<cr>
    nno <unique> <f24>? <cmd>call quickhl#show_help()<cr>
endif
